<x-admin-layout title="Edit Pustakawan">
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="row" action="{{ route('admin.librarians.update', $librarian) }}" method="POST" 
                  enctype="multipart/form-data"
                  onsubmit="return confirm('Anda yakin ingin mengedit pustakawan ini?')">
                @csrf
                @method('PUT')
                ...
                <div class="col-12 mb-4">
                    <div class="text-center">
                        <div class="mb-3">
                            <img id="photoPreview" 
                                 src="{{ $librarian->photo ? asset('storage/' . $librarian->photo) : asset('storage/placeholder.png') }}" 
                                 alt="{{ $librarian->name }}" 

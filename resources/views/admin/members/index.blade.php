                        ...
                        @forelse ($members as $member)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="text-truncate" title="{{ $member->name }}">
                                        {{ $member->name }}
                                    </div>
                                </td>
                                <td class="align-middle">{{ $member->number_type }}</td>
                                <td class="align-middle">{{ $member->number }}</td>
                                <td class="align-middle">+{{ $member->telephone }}</td>
                                <td class="align-middle">
